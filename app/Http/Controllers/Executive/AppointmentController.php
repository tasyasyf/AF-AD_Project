...
class AppointmentController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('executive.appointments.index', compact('appointments'));
    }

    public function create(): View
    {
        $profiles = Profile::verified()->with('user')->get();
        return view('executive.appointments.create', compact('profiles'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('executive.appointments.show', $appointment)
    ...
    public function show(Appointment $appointment): View
    {
        ...
        return view('executive.appointments.show', compact('appointment'));
    }

    public function edit(Appointment $appointment): View
    {
        $profiles = Profile::verified()->with('user')->get();
        return view('executive.appointments.edit', compact('appointment', 'profiles'));
    }
