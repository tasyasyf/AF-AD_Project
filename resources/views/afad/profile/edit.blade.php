...
<form method="POST" action="{{ route('afad.profile.update') }}">
@csrf @method('PUT')
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted small">Saving will reset your profile status to <strong>Pending</strong> for re-verification.</p>
