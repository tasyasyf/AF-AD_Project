            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $claim->appointment->course_code }} - {{ $claim->appointment->course_name }}" disabled>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Semester</label>
                        <input type="text" class="form-control" value="{{ $claim->appointment->semester }}" disabled>
                        </div>
                    </div>
                </div>
        </div>
