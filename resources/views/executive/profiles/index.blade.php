...
<div class="card mb-3">
    <div class="card-body py-2">
        <form method="GET" class="d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('executive.profiles.index') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
        </form>
    </div>
</div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="small">{{ $profile->qualification_level }} – {{ Str::limit($profile->qualification, 30) }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted py-4">No profiles found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
