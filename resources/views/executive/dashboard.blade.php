...
<div class="row g-3 mb-4">
    @foreach([
        ['label'=>'Pending Profiles', 'value'=>$stats['pending_profiles'], 'icon'=>'hourglass-split', 'color'=>'warning'],
        ['label'=>'Verified Profiles', 'value'=>$stats['verified_profiles'], 'icon'=>'check-circle-fill', 'color'=>'success'],
        ['label'=>'Claims for Review', 'value'=>$stats['claims_submitted'] + $stats['claims_under_review'], 'icon'=>'file-earmark-check', 'color'=>'primary'],
